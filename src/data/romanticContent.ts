...
export const INITIAL_PHOTOS: MemoryPhoto[] = [
  {
    ...
    title: 'Cafe Dates & Sweet Smiles',
    date: 'A Cozy Afternoon',
    location: 'Our Favorite Cafe Spot ☕',
    caption: 'Sitting across from you, having coffee, and getting lost in your eyes. Every second with you feels like home.',
  ...
  },
  {
    ...
    title: 'Goofy Days & Big Smiles',
    date: 'Garden Walk',
    location: 'Under the Greenery 🌿',
    caption: 'With you, I can be 100% silly and unapologetically myself. You match my goofy energy every single time!',
    vibeTag: 'Goofy Vibes 😜',
    rotation: 2.2,
    sticker: '🌻',
  },
  {
    ...
    title: 'My Favorite Teammate',
    date: 'Game Day Vibes',
    location: 'Chill Lounge 💜',
    caption: 'No matter what game we play or what we do, having you by my side makes everything a thousand times more fun.',
  ...
  },
  {
    ...
    caption: 'You have the cutest laugh in the whole universe. Whenever you smile like this, my whole day instantly gets brighter.',
    vibeTag: 'Pure Joy 🥰',
    rotation: -3.1,
    sticker: '👅',
  },
  {
    ...
    caption: 'Forehead kisses, golden sunshine, holding hands over the center console, and singing along to our favorite songs together.',
